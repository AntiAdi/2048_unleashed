...
# Plotting with THICK bars
plt.figure(figsize=(12, 8))
plt.bar(tiles, game_counts, color='skyblue', width=40)  # wider bars (default is 0.8 for bar charts)
plt.xlabel('Maximum Tile Reached', fontsize=14)
plt.ylabel('Number of Games', fontsize=14)
plt.title('Maximum Tile Reached vs Number of Games', fontsize=16)
plt.xticks(tiles, fontsize=12)
plt.yticks(fontsize=12)
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()

# Save the figure
plt.savefig("largest_tile_vs_num_games.png", dpi=300)  # 300 DPI is usually sharp enough
plt.show()
