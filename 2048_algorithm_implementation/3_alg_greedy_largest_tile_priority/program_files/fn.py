...
def dummy_move_left(dummy_matrix) :
        ...
        for main_column in range(3) :
            ...
            for second_column in range(main_column+1, 4) :
                ...
                if dummy_matrix[row][main_column] == dummy_matrix[row][second_column] and not merged[second_column] :
                    ...
                    if dummy_matrix[row][main_column] > largest_tile :
                        largest_tile = dummy_matrix[row][main_column]
                    any_movement = True
                    merged[main_column] = True
                    break
    ...
    if any_movement :
        dummy_add_2_or_4(dummy_matrix)
        # pass
    return any_movement, score_change, largest_tile
        ...
        for main_row in range(3) :
            ...
            for second_row in range(main_row+1, 4) :
                ...
                if dummy_matrix[main_row][column] == dummy_matrix[second_row][column] and not merged[second_row]:
                    ...
                    if dummy_matrix[second_row][column] > largest_tile :
                        largest_tile = dummy_matrix[second_row][column]
        ...
        for main_row in range(3) :
            ...
            for second_row in range(main_row+1, 4) :
                ...
                if dummy_matrix[main_row][column] == dummy_matrix[second_row][column] and not merged[second_row] :
                    ...
                    if dummy_matrix[main_row][column] > largest_tile :
                        largest_tile =dummy_matrix[main_row][column]
