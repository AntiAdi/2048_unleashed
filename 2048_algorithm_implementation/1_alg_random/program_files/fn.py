...
# Dummy Functions for Back Testing. They take a duplicate matrix and dont affect the real one.
...
# Function to log moves and score and board state and direction of move.
