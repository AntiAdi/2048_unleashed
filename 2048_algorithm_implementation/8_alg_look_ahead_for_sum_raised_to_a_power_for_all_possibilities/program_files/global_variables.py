...
# Global variable to keep track of the number of moves and game state.
global moves 
moves = 0
...
# Main Instance
root = Tk()
root.title("2048 Algorithm Implementation : Look Ahead for Max Sum**10")
# root.geometry("400x400")


# To track depth states
global move_list 
move_list = []
...
# Adding Label for Current Score.
global lab_score
lab_score = Label(root, text=f"Current Score = {score}",font=("", 16))

# Adding Clear Button
global but_reset
but_reset = Button(root, text="Reset")


# Adding Undo Button
global but_undo
but_undo = Button(root, text="Undo")
